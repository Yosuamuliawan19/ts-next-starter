  ...
  return (
    <div className={'flex my-2 flex-col md:flex-row  '}>
      ...
      <div className="block p-4 md:p-8">
        ...
        <div
          className="font-display bold text-sm text-gray-400 pb-1 flex"
          style={{ color: '#14a01d' }}
        >
          {tags.map((data) => {
            return (
              <div className="my-2 rounded-md mr-2 bg-green-100 text-green-500 font-display bold flex items-center text-sm  px-2 py-1">
                {data}
              </div>
            );
          })}
