  ...
  return (
    <>
      <div
        className={
          styles.sidebar +
          ' z-max fixed left-0 bottom-0 lg:top-0 flex lg:flex-col justify-center w-screen lg:w-auto lg:h-screen h-12 items-center px-2 bg-white'
        }
      >
        {/*<div>*/}
        ...
        <Link href={EXTERNAL_LINKS.MEDIUM}>
          <div className={'p-2 lg:mb-6 rounded-lg ' + styles.icon}>
